...
public class PotionAddArg extends CommandArgument {
    ...
    public PotionAddArg(CelesteEssentials main) {
        super(true, "add", "adicionar");
        this.main = main;
    ...
    public void execute(CommandSender sender, String[] args) {
        ...
        String mode = config.getMessage("Potion.Add");
